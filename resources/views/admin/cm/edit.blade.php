                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <div class="form-panel col-md-6 col-sm-12">
                                ...
                                <form class="row g-3" method="POST" action="{{ url('admin/collection_method/' . $model->id) }}">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <a class="btn btn-sm btn-secondary" href="{{ url('admin/collection_method') }}">Back to All Collection Methods</a>
                                    </div>
