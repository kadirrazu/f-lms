                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">
                                {{ $page_subtitle ?? ""}}
                                | <span>
                                    <a href="{{ url('admin/collection_method') }}">All Collection Methods</a>
                                </span>
                            </h5>

                            <div class="form-panel col-md-6 col-sm-12">
                            
                                <form class="row g-3" method="POST" action="{{ url('admin/collection_method') }}">
                                    ...
                                    <div class="col-md-12 col-sm-12 mt-3">
                                        <button class="btn btn-sm btn-primary w-auto" type="submit">Add Collection Method</button> &nbsp;
                                        <a class="btn btn-sm btn-warning" href="{{ url('admin/collection_method') }}">Back to All Collection Methods</a>
                                    </div>
