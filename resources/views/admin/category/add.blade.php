                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <div class="form-panel col-md-6 col-sm-12" x-data="{ title_en : '' }" >
                                ...
                                <form class="row g-3" method="POST" action="{{ url('admin/category') }}">
                                    ...
                                    <div class="col-md-12 col-sm-12 mt-3">
                                        <button class="btn btn-sm btn-primary w-auto" type="submit">Add Category</button> &nbsp;
                                        <a class="btn btn-sm btn-warning" href="{{ url('admin/category') }}">Back to All Categories</a>
                                    </div>
