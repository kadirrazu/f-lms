                ...
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <a class="btn btn-sm btn-success" href="{{ url('admin/publisher') }}">Back to All Publishers</a> &nbsp;
                            <a class="btn btn-sm btn-warning" href="{{ url('admin/publisher/' . $model->id . '/edit') }}">Edit</a>
