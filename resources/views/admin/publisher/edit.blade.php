                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <div class="form-panel col-md-6 col-sm-12">
                                ...
                                <form class="row g-3" method="POST" action="{{ url('admin/publisher/' . $model->id) }}">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <x-form.input name="slug" type="text" :value="old('slug', $model->slug)"/>
                                        </div>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <a class="btn btn-sm btn-secondary" href="{{ url('admin/publisher') }}">Back to All Publishers</a>
                                    </div>
