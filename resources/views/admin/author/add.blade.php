                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">
                                {{ $page_subtitle ?? ""}}
                                | <span>
                                    <a href="{{ url('admin/author') }}">All Authors</a>
                                </span>
                            </h5>

                            <div class="form-panel col-md-6 col-sm-12" x-data="{ title_en : '' }" >
                            
                                <form class="row g-3" method="POST" action="{{ url('admin/author') }}">
                                    ...
                                    <div class="col-md-12 col-sm-12 mt-3">
                                        <button class="btn btn-sm btn-primary w-auto" type="submit">Add Author</button> &nbsp;
                                        <a class="btn btn-sm btn-warning" href="{{ url('admin/author') }}">Back to All Authors</a>
                                    </div>
